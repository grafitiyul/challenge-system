  ...
  return (
    <div className="page-wrapper" style={{ maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: 16 }}>
        <Link href={`/admin/participants/${participantId}?tab=goals`} style={{ fontSize: 13, color: '#2563eb' }}>
          ← חזרה לפרופיל
        </Link>
      </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {plan.goals.map((goal, gIdx) => (
                <GoalSection
                  ...
                  onAddTask={() => setAddTaskModal({ goalId: goal.id })}
                  viewOnly={viewOnly}
