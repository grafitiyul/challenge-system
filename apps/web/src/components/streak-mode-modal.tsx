      ...
      {({ attemptClose }) => (
        <>
          ...
          {modeRadio(
            ...
            'רצף במשחק מתחיל מ-0. ההיסטוריה מהמשחקים הקודמים לא תוצג למשתתפת בקבוצה זו.',
          )}
          {modeRadio(
            'continue',
            'המשך מהמשחק הקודם',
            'רצף במשחק עדיין מתחיל מ-0, אבל המשתתפת רואה את הרצף האישי שלה מהמשחקים הקודמים. הניקוד מתחיל מ-0.',
          )}
          {modeRadio(
            'override',
            'עריכה ידנית',
